...
class WebApiTests(unittest.TestCase):
    ...
    def test_get_metric_profiles(self, mock_request):
        ...
        self.assertEqual(
            log.output,
            [
                "INFO:argo-scg.webapi:MOCK_TENANT: Fetching metric profiles...",
                "INFO:argo-scg.webapi:MOCK_TENANT: Fetching metric profiles... "
                "ok"
            ]
        )
    ...
    def test_error_fetching_metricprofiles_with_msg(self, mock_get):
        ...
        self.assertEqual(
            log.output,
            [
                f"INFO:{self.logname}:MOCK_TENANT: Fetching metric profiles...",
    ...
    def test_get_topology(self, mock_request):
        ...
        self.assertEqual(
            log.output, [
                ...
                f"Fetching topology endpoints...",
                f"INFO:{self.logname}:MOCK_TENANT: "
                f"Fetching topology endpoints... ok"
            ]
        )
